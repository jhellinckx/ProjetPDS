...
public class RequestNameContainer {
    private static final ArrayList<String> names = new ArrayList<>(Arrays.asList(LOG_IN_REQUEST,
            ...
            SEND_RATINGS_REQUEST, SPORTS_LIST_REQUEST, UPDATE_DATA_REQUEST,
            DATA_REQUEST, RECOMMEND_REQUEST, HISTORY_REQUEST, FOOD_CODE_REQUEST_HISTORY, HISTORY_FOR_DATE_REQUEST));
