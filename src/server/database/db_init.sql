...
LOAD DATA LOCAL INFILE '/home/end3rs/Téléchargements/en.openfoodfacts.org.products.csv' #CHEMIN à modif
INTO TABLE Food
LINES TERMINATED BY '\n'
IGNORE 1 LINES
...
CREATE TABLE db_appli.User_preferences(
	...
	rank DECIMAL(2,1) NOT NULL, #2ch. significatifs, 1 après la virg.
	PRIMARY KEY (id)
)ENGINE=INNODB;
