...
def create_food_table():
	...
	sql_types = 
			{
				BaseArticle.BRANCH_INDEX_KEY 						: "UNSIGNED",\
				...
				DetailedArticle.PORTION_ENERGY_KJ_KEY 				: "VARCHAR(10)",\
				DetailedArticle.PORTION_ENERGY_KCAL_KEY 			: "VARCHAR(10)",\
				DetailedArticle.PORTION_TOTAL_FAT_KEY 				: "VARCHAR(10)",\
				DetailedArticle.PORTION_SATURATED_FAT_KEY 			: "VARCHAR(10)",\
				DetailedArticle.PORTION_TOTAL_CARBOHYDRATES_KEY 	: "VARCHAR(10)",\
				DetailedArticle.PORTION_SUGARS_KEY 					: "VARCHAR(10)",\
				DetailedArticle.PORTION_TOTAL_PROTEINS_KEY 			: "VARCHAR(10)",\
				DetailedArticle.PORTION_FIBERS_KEY 					: "VARCHAR(10)",\
				DetailedArticle.PORTION_SALT_KEY 					: "VARCHAR(10)",\
				DetailedArticle.PORTION_INFO_KEY 					: "VARCHAR(10)",\
				DetailedArticle.PER_100G_ENERGY_KJ_KEY 				: "VARCHAR(10)",\
				DetailedArticle.PER_100G_ENERGY_KCAL_KEY 			: "VARCHAR(10)",\
				DetailedArticle.PER_100G_TOTAL_FAT_KEY 				: "VARCHAR(10)",\
				DetailedArticle.PER_100G_SATURATED_FAT_KEY 			: "VARCHAR(10)",\
				DetailedArticle.PER_100G_TOTAL_CARBOHYDRATES_KEY 	: "VARCHAR(10)",\
				DetailedArticle.PER_100G_SUGARS_KEY 				: "VARCHAR(10)",\
				DetailedArticle.PER_100G_TOTAL_PROTEINS_KEY 		: "VARCHAR(10)",\
				DetailedArticle.PER_100G_FIBERS_KEY 				: "VARCHAR(10)",\
				DetailedArticle.PER_100G_SALT_KEY					: "VARCHAR(10)",\
