...
public interface FoodDAO {
	...
	List<Food> findFoodWithLessThanLevels(float energy, float fat, float proteins, float saturatedFat, float carbohydrates, float sugars, float salt) throws DAOException;
